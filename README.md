...
| **Direcció General Policia (DGP)** | Residència | Consulta de l'històric de tràmits de residència legal. | [Documentació homologació Residència][linkDGP_Residència]   |
|**Direcció General Policia (DGP)** | Residència Legal estrangers | Residència Legal Estrangers | [Documentació homologació Residència Legal][linkDGP_Residencia_Legal]   |
| **Direcció General Trànsit (DGT)** | Registre de vehicles i conductors | Consulta de dades d’un vehicle, Consulta de dades d’un vehicle per a sancions (Aquesta consulta requereix disposar de conveni amb la DGT),Consulta de dades dels permisos de conduir d'un conductor,Consulta de dades d'un vehicle per part del titular de la via,Consulta de sancions, vigències i condemnes penals d'un conductor,Consulta dels vehicles enregistrats a la DGT per a un propietari,Consulta del distintiu mediambiental d’un vehicle,Consulta de vehicles UE (o europeus) per infracció de trànsit,Consulta de dades d’un vehicle per l’impost de vehicles de tracció mecànica,Verificació del titular d’un vehicle, Historial de domicilis d’un propietari,Historial de domicilis d’un vehicle | [Documentació homologació Registre de vehicles i conductors][linkDGT_RegVehICond]   |
